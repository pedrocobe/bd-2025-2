...
export const UsersQueries = {
  ...
  `,
  /**
   * activate - Activar usuario (contraparte de deactivate)
   * 
   * Descripción: Marca un usuario como activo (is_active = true)
   * Parámetros: $1 = id (integer)
   * Retorna: id, username, is_active
   */
  activate: `
    UPDATE users
    SET is_active = true,
  ...
  /**
   * countActive - Contar usuarios activos
   * 
   * Descripción: Cuenta cuántos usuarios están activos en el sistema
   * Parámetros: ninguno
   * Retorna: count (número de usuarios activos)
   */
  countActive: `
