...
-- GRANTS ESPECÍFICOS (funciones nuevas)
-- Otorgar EXECUTE de forma explícita a roles que ejecutarán funciones
GRANT EXECUTE ON FUNCTION calculate_order_subtotal(integer) TO db_manager;
GRANT EXECUTE ON FUNCTION apply_discount(numeric, numeric) TO db_manager;
GRANT EXECUTE ON FUNCTION calculate_tax(numeric) TO db_manager;
GRANT EXECUTE ON FUNCTION update_customer_statistics(integer) TO db_manager;
GRANT EXECUTE ON FUNCTION check_product_availability(integer, integer) TO db_manager;
GRANT EXECUTE ON FUNCTION calculate_profit_margin(integer) TO db_manager;
GRANT EXECUTE ON FUNCTION days_since_last_order(integer) TO db_manager;
GRANT EXECUTE ON FUNCTION get_inventory_value() TO db_manager;

-- Permisos de ejecución para reporting (solo lectura)
GRANT EXECUTE ON FUNCTION calculate_order_subtotal(integer) TO db_readonly;
GRANT EXECUTE ON FUNCTION apply_discount(numeric, numeric) TO db_readonly;
GRANT EXECUTE ON FUNCTION calculate_tax(numeric) TO db_readonly;
GRANT EXECUTE ON FUNCTION check_product_availability(integer, integer) TO db_readonly;
GRANT EXECUTE ON FUNCTION calculate_profit_margin(integer) TO db_readonly;
GRANT EXECUTE ON FUNCTION days_since_last_order(integer) TO db_readonly;
GRANT EXECUTE ON FUNCTION get_inventory_value() TO db_readonly;
